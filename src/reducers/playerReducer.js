  ...
  switch(action.type) {
    ...
    case actions.LOAD_LEVEL_INSTANCE:
      newState = {
        ...
        emittedLevels: {
          ...state.emittedLevels,
          [action.level.factoryContractDeployedAddress]: action.instance.address
        }
      }
      ...
      if(action.completed) {
        newState = {
          ...
          completedLevels: {
            ...
            [action.level.factoryContractDeployedAddress]: action.completed
          }
        }
        cachePlayer(newState)
      }
